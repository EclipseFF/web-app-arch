...
export default function Header() {
    ...
    return (
        <header className="p-4 sm:p-6">
            <div className=" flex flex-col sm:flex-row justify-between items-center">
                ...
                <div className="flex-grow flex justify-center gap-4 mb-4 sm:mb-0">
                    <button onClick={() => router.push('/superadmin')}
                            className="bg-purple-500 text-white py-2 px-4 rounded-lg">Рестораны
                    </button>
                    <button onClick={() => router.push('/superadmin/series')}
                            className="bg-purple-500 text-white py-2 px-4 rounded-lg">Франшизы
                    </button>
                    <button onClick={() => router.push('/superadmin/users')}
                            className="bg-purple-500 text-white py-2 px-4 rounded-lg">Пользователи
                    </button>
                    <button onClick={() => router.push('/superadmin/access')}
                            className="bg-purple-500 text-white py-2 px-4 rounded-lg">Доступ
                    </button>
            ...
            <h2 className="text-lg font-bold mb-4 text-center">Личный кабинет:</h2>
        </header>
    )
}